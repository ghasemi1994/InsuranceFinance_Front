...
export default function InstallmentReminderSetting() {

    const { control } = useFormContext<ReminderRuleRequest>();

    const { fields, append, remove } = useFieldArray({
        control,
        name: "installmentConfigRule"
    })
                                    ...
                                    <Grid2 container spacing={2}>
                                        ...
                                        <Grid2 size={12}>
                                            <FormControl fullWidth>
                                                ...
                                                <Controller
                                                    control={control}
                                                    name={`installmentConfigRule.${index}.sendTimeReminder`}
                                                    render={({ field }) => (
                                        ...
                                        <Grid2 size={{ xl: 4, lg: 4, md: 6, sm: 6, xs: 12 }}>
                                            <FormControl fullWidth>
                                                ...
                                                <Controller
                                                    control={control}
                                                    name={`installmentConfigRule.${index}.reminderChannelType`}
                                                    render={({ field }) => (
                                                        <Select {...field} >
                                        ...
                                        <Grid2 size={{ xl: 4, lg: 4, md: 6, sm: 6, xs: 12 }}>
                                            <FormControl fullWidth>
                                                ...
                                                <Controller
                                                    control={control}
                                                    name={`installmentConfigRule.${index}.time`}
                                                    render={({ field }) => (
                                        ...
                                        <Grid2 size={{ xl: 4, lg: 4, md: 6, sm: 6, xs: 12 }}>
                                            <FormControl fullWidth>
                                                ...
                                                <Controller
                                                    control={control}
                                                    name={`installmentConfigRule.${index}.reminderAutoSend`}
                                                    render={({ field }) => (
                                                        <FormControlLabel
                                                            control={
                                                                <Checkbox
